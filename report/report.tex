...
\citeauthor{Rauber2023} posits that the number of transistors on a microchip doubles rougly every two years, leading to an exponential increase in computing power. However, according to \cite{Mattson2014} and \cite{Rauber2023}, this trend dwindled around 2005, as a limit was reached on how many transistors could be placed on a single computer chip without overheating and damaging the circuitry. Even by utilizing the most advanced tricks and optimizations available, the performance improvements we are seeing annually as of 2023 are somewhere around 3.5\% faster CPU clock speeds \parencite[p. 11]{Rauber2023} which is a far cry from the 50\% annual increases we were seeing in the early 2000's \parencite[p. 11]{Rauber2023}. 
...
\subsection{OS Scheduler}

\subsection{JVM Scheduler}
